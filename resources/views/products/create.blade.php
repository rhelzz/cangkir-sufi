            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="description" id="description" rows="2" 
                        class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="file" name="image" id="image" 
                            class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('image') border-red-500 @enderror"
                            accept="image/*">
                        @error('image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-5">
                    ...
                    <div id="ingredients-container" class="space-y-2">
                        <div class="ingredient-item flex gap-2 items-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addIngredientBtn.addEventListener('click', function() {
        ...
        ingredientItem.className = 'ingredient-item flex gap-2 items-center';
